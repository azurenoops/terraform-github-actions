...
## Demo
This a demo of the process for apply a terraform change using the [`azurenoops/terraform-plan`](https://github.com/azurenoops/terraform-github-actions/tree/main/terraform-plan) and [`azurenoops/terraform-apply`](https://github.com/azurenoops/terraform-github-actions/tree/main/terraform-apply) actions.
...
from an existing comment generated by the [`azurenoops/terraform-plan`](https://github.com/azurenoops/terraform-github-actions/tree/main/terraform-plan)
action.
